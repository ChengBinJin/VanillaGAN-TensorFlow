...
class Solver(object):
    ...
    def train(self):
        print('hello train!')
        print('number of training data: {}'.format(self.dataset.num_trains))

        imgs = self.dataset.train_next_batch(self.flags.batch_size)
